...
import com.luke.skywalker.beans.BeanInfo;
import com.luke.skywalker.beans.IntrospectionException;
import com.luke.skywalker.beans.Introspector;
import com.luke.skywalker.beans.PropertyDescriptor;
...
public class BeanELResolver extends ELResolver {
   ...
   private static final String CACHE_SIZE_PROP =
    ...
    private static final int CACHE_SIZE = Integer.parseInt(
    ...
    static final class BeanProperties {
        ...
        BeanProperty get(ELContext ctx, String name) {
