...
internal abstract class ComparableDrawableWrapper<T : Drawable>(
        drawable: T
) : ComparableDrawable(), Drawable.Callback {

    var wrappedDrawable: T = drawable.apply { callback = this@ComparableDrawableWrapper }
        set(value) {
            field.callback = null
            field = value
            field.callback = this
