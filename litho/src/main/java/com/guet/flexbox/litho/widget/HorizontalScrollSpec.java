...
public class HorizontalScrollSpec {
    ...
    static void onMeasure(
        ...
        childComponentTree.setRootAndSizeSpec(
                childComponent, SizeSpec.makeSizeSpec(0, UNSPECIFIED), heightSpec, contentSize);
        childComponent.measure(context, SizeSpec.makeSizeSpec(0, UNSPECIFIED), heightSpec, contentSize);
    ...
    static void onMount(
            ...
            @Prop(optional = true) final OnInterceptTouchListener onInterceptTouchListener,
        ...
        horizontalScrollLithoView.setOnInterceptTouchListener(onInterceptTouchListener);
    ...
    static void onCreateInitialState(
        ...
        position.x = initialScrollPosition == null
                ? LAST_SCROLL_POSITION_UNSET
                : initialScrollPosition;
        lastScrollPosition.set(position);
    ...
    static class HorizontalScrollLithoView extends HorizontalScrollView {
        ...
        @Nullable
        private HorizontalScrollSpec.OnScrollChangeListener mOnScrollChangeListener;
